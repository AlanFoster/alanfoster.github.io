...
const metadata = {
  name: 'Alan Foster',
  description: 'This is the blog of Alan Foster; a developer with a passion for learning new programming languages, frameworks, and paradigms.'
};
  ...
  <Container>
    <footer className={styles.footer}>
      <Row>
        <Col>
          <div>Alan Foster</div>
          <div><a href="mailto:alan@alanfoster.me">alan@alanfoster.me</a></div>
        </Col>
